...
for step in tqdm(range(steps)):
    ...
    figname = f"./plots/{env_name}/{'W' if weighted_gp else ''}JEDi_" + str(wtfs_alpha) + "_count_" + str(step) + ".png"
...
if savefig:
    figname = f"./plots/{env_name}/{'W' if weighted_gp else ''}JEDi_"  + str(wtfs_alpha) + "_count.png"
    # create folder if it does not exist
    import os
    os.makedirs(os.path.dirname(figname), exist_ok=True)
    print("Save figure in: ", figname)
